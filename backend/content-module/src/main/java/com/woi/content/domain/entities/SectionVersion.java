...
/**
 * SectionVersion domain entity - Pure POJO (no JPA annotations)
 * Immutable version of Section content
 * 
 * Business logic:
...
public class SectionVersion {
    private Long id;
    private Long sectionId;  // Soft reference
    ...
    /**
     * Factory method: Create a new section version
     * 
     ...
     * @return New SectionVersion instance
     * @throws IllegalArgumentException if validation fails
     */
    public static SectionVersion create(Long sectionId, Integer versionNumber,
