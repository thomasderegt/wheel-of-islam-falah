...
/**
 * JPA entity for UserObjective (database mapping)
 */
@Entity
@Table(name = "user_objectives", schema = "goals_okr")
public class UserObjectiveJpaEntity {
    ...
    private Long userGoalId; // FK to goals_okr.user_goals
