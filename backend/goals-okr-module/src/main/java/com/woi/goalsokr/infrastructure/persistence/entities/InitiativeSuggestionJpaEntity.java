...
/**
 * JPA entity for InitiativeSuggestion (database mapping)
 */
@Entity
@Table(name = "initiative_suggestions", schema = "goals_okr")
public class InitiativeSuggestionJpaEntity {
    ...
    public InitiativeSuggestionJpaEntity() {}
