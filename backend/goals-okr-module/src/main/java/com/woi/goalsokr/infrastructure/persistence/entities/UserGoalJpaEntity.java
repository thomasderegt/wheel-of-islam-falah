...
/**
 * JPA entity for UserGoal (database mapping)
 */
@Entity
@Table(name = "user_goals", schema = "goals_okr")
public class UserGoalJpaEntity {
    ...
    @Column(name = "life_domain_id")
    private Long lifeDomainId; // Optional FK to goals_okr.life_domains
